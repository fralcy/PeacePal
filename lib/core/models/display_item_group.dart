...
/// Achievement groups that have visual display items in their associated scene.
/// Engagement and Score are excluded — they are cross-cutting with no scene.
...
extension DisplayItemGroupX on DisplayItemGroup {
  ...
  /// Living-room groups use 4 different images (shape changes each tier).
  /// Game-room groups accumulate instances of the same image.
