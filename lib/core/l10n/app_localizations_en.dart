...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get remindBeforeMinutes => 'Remind before (minutes)';
  ...
  @override String get approveJoin => 'Approve New Players';
  @override String get approveLabel => 'Approve';
  @override String get remove => 'Remove';
  @override String get pendingApproval => 'Waiting for host approval...';
  ...
  @override String get singleplayer => 'Singleplayer';
  @override String get multiplayer => 'Multiplayer';
  @override String get createRoom => 'Create Room';
  @override String get scanning => 'Scanning...';
  @override String get startServer => 'Starting server...';
  @override String get connecting => 'Connecting...';
  @override String get reconnecting => 'Reconnecting...';
  @override String get hostsFound => 'Hosts found';
  @override String get rescan => 'Rescan';
  @override String get connectionLost => 'Connection lost';
  @override String get restartServer => 'Restart server';
  ...
  @override
  String get forgotPasswordDescription => 'No worries! Enter your email address and we\'ll send you a reset link.';

  @override
  String get forgotPasswordEmailSentDescription => 'We\'ve sent password reset instructions to your email address.';
  ...
  @override
  String get checkYourInbox => 'Check your inbox and follow the instructions to reset your password.';
  ...
  String achievementTitle(String id) {
    switch (id) {
      ...
      case 'first_schedule_task': return 'First Task';
      case 'schedule_task_15': return 'Planner';
      case 'schedule_task_75': return 'Disciplined';
      case 'schedule_task_150': return 'Schedule Master';
      case 'first_diary': return 'First Entry';
      case 'diary_5': return 'Budding Diarist';
      case 'diary_15': return 'Consistent Writer';
      case 'diary_30': return 'Inner Writer';
      case 'first_breath': return 'First Breath';
      case 'breathing_5': return 'Calm Seeker';
      case 'breathing_15': return 'Mindful Breather';
      case 'breathing_30': return 'Breathing Master';
      case 'first_sleep_log': return 'Sleep Tracker';
      case 'sleep_log_5': return 'Rest Starter';
      case 'sleep_log_15': return 'Sleep Habit';
      case 'sleep_log_30': return 'Sleep Expert';
      case 'first_plant': return 'Green Thumb';
      case 'plant_30': return 'Seedling Keeper';
      case 'plant_80': return 'Patient Gardener';
      case 'plant_160': return 'Master Gardener';
      case 'first_fish_fed': return 'First Feeding';
      case 'fish_fed_15': return 'Fish Friend';
      case 'fish_fed_150': return 'Fish Keeper';
      case 'fish_fed_300': return 'Fish Master';
      case 'first_painting': return 'First Stroke';
      ...
      case 'first_music': return 'First Note';
  ...
  String achievementDescription(String id) {
    switch (id) {
      ...
      case 'first_schedule_task': return 'Complete your first scheduled task';
      case 'schedule_task_15': return 'Complete 15 scheduled tasks';
      case 'schedule_task_75': return 'Complete 75 scheduled tasks';
      case 'schedule_task_150': return 'Complete 150 scheduled tasks';
      case 'first_diary': return 'Write your first emotion diary entry';
      case 'diary_5': return 'Write 5 diary entries';
      case 'diary_15': return 'Write 15 diary entries';
      case 'diary_30': return 'Write 30 diary entries';
      case 'first_breath': return 'Complete your first breathing session';
      case 'breathing_5': return 'Complete 5 breathing sessions';
      case 'breathing_15': return 'Complete 15 breathing sessions';
      case 'breathing_30': return 'Complete 30 breathing sessions';
      case 'first_sleep_log': return 'Log your sleep for the first time';
      case 'sleep_log_5': return 'Log your sleep 5 times';
      case 'sleep_log_15': return 'Log your sleep 15 times';
      case 'sleep_log_30': return 'Log your sleep 30 times';
      case 'first_plant': return 'Plant your first seed';
      case 'plant_30': return 'Plant seeds 30 times';
      case 'plant_80': return 'Plant seeds 80 times';
      case 'plant_160': return 'Plant seeds 160 times';
      case 'first_fish_fed': return 'Feed your fish for the first time';
      case 'fish_fed_15': return 'Feed your fish 15 times';
      case 'fish_fed_150': return 'Feed your fish 150 times';
      case 'fish_fed_300': return 'Feed your fish 300 times';
      case 'first_painting': return 'Paint your first pixel';
      ...
      case 'first_music': return 'Place your first note in a composition';
